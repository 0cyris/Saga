...
- Render Danger Zone directly without the collapsible Settings dropdown, because destructive cleanup should be visible as one clearly scoped card at the bottom of Settings.
...
- [x] Danger Zone renders directly in Settings without a dropdown.
