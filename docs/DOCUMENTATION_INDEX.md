...
- [Saga for Desktop Operator's Manual](user/DESKTOP_OPERATOR_MANUAL.md): full screenshot-backed guide to the desktop/tablet Session, Loredecks, Pack Health, Deck Maker, Context, Lorecards, Continuity, Injection, Settings, and troubleshooting surfaces.
