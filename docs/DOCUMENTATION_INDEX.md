...
- [Saga Mobile Support Parallelization Addendum](development/SAGA_MOBILE_SUPPORT_PARALLELIZATION_ADDENDUM.md): three-agent handoff plan for splitting mobile shell primitives, operator tabs and Lorecards lifecycle, heavy workbenches, walkthroughs, and verification.
