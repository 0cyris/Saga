...
- [Basic Workflow](user/BASIC_WORKFLOW.md): sectioned Basic Walkthrough for loading Lorepacks, setting Context, reviewing Lorecards, checking Settings, and continuing roleplay without advanced prompt controls.
- [Advanced Workflow](user/ADVANCED_WORKFLOW.md): sectioned Advanced Walkthrough for Loredecks, Session, Context, Continuity, Lorecards, Injection, Settings, Creator, Pack Health, and diagnostics.
...
- [Basic Experience Implementation Plan](development/SAGA_BASIC_EXPERIENCE_IMPLEMENTATION_PLAN.md): focused feature plan for hiding Injection in Basic mode while adding the Start Checklist and sectioned Basic Walkthrough.
- [Walkthrough Workflow Expansion Plan](development/SAGA_WALKTHROUGH_WORKFLOW_EXPANSION_PLAN.md): coverage-driven plan for expanding Basic and Advanced walkthrough modules without fixed step-count limits.
