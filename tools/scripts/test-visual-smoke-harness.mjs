...
assert(defaultState.includes('stateSafety:') && defaultSettings.includes("'settings.stateSafety'") && defaultSettings.includes("'settings.dangerZone'"), 'Default state and settings collapse map must expose State Safety and the relocated Danger Zone.');
