...
assert(runtimeShellView.includes("activeSubview?.id === 'session-story-opener'") && runtimeShellView.includes('return null;'), 'Story Opener mobile subview must not render the shell Back button.');
