...
assert(runtimeStoryOpenerPanel.includes('handleStoryOpenerStageAction') && runtimeStoryOpenerPanel.includes("options.navigateRuntimeTab('loredecks')") && runtimeStoryOpenerPanel.includes('stage.actionLabel || stage.label'), 'Story Maker stage bar must render and handle the Add Loredecks action label.');
...
assert(style.includes('.saga-story-opener-stage-action-add_loredecks') && style.includes('.saga-story-opener-stage-action') && style.includes('opacity: 1'), 'Story Maker Add Loredecks stage action must not inherit the dead-looking locked-stage opacity.');
