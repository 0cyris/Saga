...
assert(style.includes('.saga-story-opener-variant-count-control') && style.includes('.saga-story-opener-variant-count-slider') && style.includes('accent-color: var(--saga-gold'), 'Story Maker variant-count slider must have compact themed styling.');
