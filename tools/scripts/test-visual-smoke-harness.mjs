...
assert(/function getFreshLoredeckLibraryPack\(packId, fallback = null\) \{[\s\S]*hydrateCachedExternalLorepackPayloadRecord\(fresh\)/.test(panel), 'Runtime fresh Loredeck reads must merge cached external payloads before follow-up validation can resave stale Pending Review rows.');
