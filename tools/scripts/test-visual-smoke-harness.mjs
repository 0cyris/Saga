...
assert(runtimeStoryOpenerPanel.includes('container.appendChild(createStoryOpenerStageBar(session, state, options));\n    const generationStatus = createStoryOpenerGenerationStatus(session);') && runtimeStoryOpenerPanel.includes('if (generationStatus) container.appendChild(generationStatus);'), 'Story Maker live generation status must sit directly under the workflow stage rail.');
