...
const gateScripts = [
  ...
  'tools/scripts/test-canon-lore-db-virtual-sources.mjs',
  ...
  'tools/scripts/test-loredeck-package-install.mjs',
  'tools/scripts/test-loredeck-library-folders.mjs',
  ...
  'tools/scripts/test-loredeck-health-panel-duplicate-payload-hydration.mjs',
