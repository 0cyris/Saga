...
import { getState, getSettings, saveState, MAX_PENDING_LORE_ENTRIES, getLoredeckLibraryRegistry } from '../state/state-manager.js';
import { normalizeLoreMatrix, buildLoreGenerationKey } from '../lorecards/lore-matrix.js';
import { preprocessPendingLoreEntries } from '../lorecards/pending-lore-preprocessor.js';
import { normalizeLorePurpose, computeSpecificityScore, isSpecificLorePurpose } from '../lorecards/lore-relevance.js';
import { combineLoredeckHealth, fetchJson, loadLoredeckStackSources } from '../loredecks/loredeck-loader.js';
...
import { buildLoredeckRetrievalAudit, recordLoredeckRetrievalAudit } from '../lorecards/retrieval-audit.js';
