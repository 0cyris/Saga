...
export const TAB_ICON_PATHS = {
    loredecks: './assets/iconsets/saga-hero/hero-tab-loredecks-256.png',
    session: './assets/iconsets/saga-hero/hero-tab-session-256.png',
    context: './assets/iconsets/saga-hero/hero-tab-context-256.png',
    continuity: './assets/iconsets/saga-hero/hero-tab-continuity-256.png',
    lore: './assets/iconsets/saga-hero/hero-tab-lorecards-256.png',
    injection: './assets/iconsets/saga-hero/hero-tab-injection-256.png',
    settings: './assets/iconsets/saga-hero/hero-tab-settings-256.png',
};

export const BRAND_LOGO_PATHS = {
    compact: './assets/branding/saga-s-256.png',
    expanded: './assets/branding/saga-banner-512.png',
};
...
export const BUNDLED_ICONSET_PRESETS = Object.freeze([
    ...
    },
    {
        ...
        preferredSize: 256,
        icons: {
            'tab.loredecks': './assets/iconsets/saga-mystic/mystic-tab-loredecks-256.png',
            'tab.session': './assets/iconsets/saga-mystic/mystic-tab-session-256.png',
            'tab.context': './assets/iconsets/saga-mystic/mystic-tab-context-256.png',
            'tab.continuity': './assets/iconsets/saga-mystic/mystic-tab-continuity-256.png',
            'tab.lore': './assets/iconsets/saga-mystic/mystic-tab-lorecards-256.png',
            'tab.injection': './assets/iconsets/saga-mystic/mystic-tab-injection-256.png',
            'tab.settings': './assets/iconsets/saga-mystic/mystic-tab-settings-256.png',
            'brand.compact': BRAND_LOGO_PATHS.compact,
            'brand.expanded': BRAND_LOGO_PATHS.expanded,
        },
    ...
    },
    {
        ...
        preferredSize: 256,
        icons: {
            'tab.loredecks': './assets/iconsets/saga-relay/relay-tab-loredecks-256.png',
            'tab.session': './assets/iconsets/saga-relay/relay-tab-session-256.png',
            'tab.context': './assets/iconsets/saga-relay/relay-tab-context-256.png',
            'tab.continuity': './assets/iconsets/saga-relay/relay-tab-continuity-256.png',
            'tab.lore': './assets/iconsets/saga-relay/relay-tab-lorecards-256.png',
            'tab.injection': './assets/iconsets/saga-relay/relay-tab-injection-256.png',
            'tab.settings': './assets/iconsets/saga-relay/relay-tab-settings-256.png',
            'brand.compact': BRAND_LOGO_PATHS.compact,
            'brand.expanded': BRAND_LOGO_PATHS.expanded,
        },
