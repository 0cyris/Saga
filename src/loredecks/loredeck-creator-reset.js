...
const LORECARD_RESET_FIELDS = {
    ...
    entryDraftLastRejectedCount: 0,
    entryDraftLastRejectedTargetIds: [],
    entryDraftLastRejectionSummary: { count: 0, targetCount: 0, targetEntryIds: [], unknownTags: [], unknownAnchors: [], byReason: {} },
    entryDraftLastRejectionDiagnostics: [],
    entryDraftLastPreflightSummary: { targetCount: 0, acceptedTagCount: 0, omittedTagCount: 0, ambiguousTagCount: 0, omittedAnchorCount: 0, omittedWindowCount: 0, planningGapCount: 0 },
