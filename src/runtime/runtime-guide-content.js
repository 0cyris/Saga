...
function buildAdvancedGuideSteps() {
    return [
        ...
        advancedStep('advanced-injection-overview', 'Injection Overview', 'Injection is the exact prompt and debugging surface for what Saga sends. On mobile Advanced, open Injection from the bottom navigation More sheet.', 'injection', 'injection.toggles', { prepare: 'openInjectionPreview' }),
        ...
        advancedStep('advanced-continuity-overview', 'Continuity Overview', 'Continuity is live scene state, distinct from durable Accepted Lorecards. On mobile Advanced, open Continuity from the bottom navigation More sheet.', 'continuity', 'continuity.scan', { prepare: 'openContinuityEditor' }),
...
export const GUIDE_SECTIONS = Object.freeze({
    ...
    advanced: freezeGuideSections([
        ...
        { id: 'sessionControl', label: 'Session And Runtime Control', tab: 'session', description: 'Control runtime mode, automation, activation, guide modules, and diagnostics; mobile starts from Session summary and Session Details.' },
        ...
        { id: 'loreReview', label: 'Lorecard Generation And Review', tab: 'lore', description: 'Generate canon/story Lorecards, review proposals, manage Accepted Lorecards, and audit changes; mobile uses Lore, Generate, and Automation sub-tabs.' },
        { id: 'injectionDiagnostics', label: 'Injection Diagnostics', tab: 'injection', description: 'Inspect prompt placement, relevance tiers, compression, previews, token pressure, and omissions; mobile Advanced opens this from More.' },
        { id: 'continuityTracking', label: 'Continuity Tracking', tab: 'continuity', description: 'Track live scene state, scan scope, performance, tracked sections, and recovery; mobile Advanced opens this from More.' },
...
export const GUIDE_CONTENT = Object.freeze({
    ...
    advanced: Object.freeze({
        ...
        lede: 'Use the full Advanced walkthrough as a complete map, or start a focused tab walkthrough for faster routing through a specific workflow. Mobile Advanced uses the same modules through bottom navigation, More routes, sub-tabs, and detail sheets.',
        note: '',
