...
function buildAdvancedGuideSteps() {
    return [
        ...
        advancedStep('advanced-context-browser-open', 'Open Context Workbench', 'Open the Context Workbench for manual timeline, waypoint, alias, resolver, and validation workflows.', 'context', 'context.browser', { fallbackTarget: 'context.commandCenter' }),
        advancedStep('advanced-context-workbench-layout', 'Workbench Layout', 'Read the Workbench as one selected loaded Lorepack, one current Context editor, quick waypoint browsing, Phrase Resolver, and full timeline search.', 'context', 'context.workbench.shell', { prepare: 'openContextBrowser' }),
        ...
        advancedStep('advanced-context-anchors-windows', 'Anchors Versus Windows', 'Anchors are exact timeline points. Windows are bounded ranges. Context eligibility changes depending on whether the current row is a point or a range.', 'context', 'context.workbench.waypoints', { fallbackTarget: 'context.workbench.editor', prepare: 'openContextBrowser' }),
        advancedStep('advanced-context-start-here', 'Start Here', 'Start Here applies one waypoint as the exact current starting Anchor and clears the need for a range.', 'context', 'context.workbench.startHere', { fallbackTarget: 'context.workbench.waypoints', prepare: 'openContextBrowser' }),
        advancedStep('advanced-context-use-window', 'Use Window', 'Use Window applies a first-class Window from the Lorepack timeline when the registry already has the correct lower and upper bounds.', 'context', 'context.workbench.useWindow', { fallbackTarget: 'context.workbench.contextPicker', prepare: 'openContextBrowser' }),
        advancedStep('advanced-context-use-anchor', 'Use Anchor', 'Use Anchor applies an exact Anchor from Select From Timeline; it is the search/table equivalent of choosing a single point.', 'context', 'context.workbench.useAnchor', { fallbackTarget: 'context.workbench.contextPicker', prepare: 'openContextBrowser' }),
        ...
        advancedStep('advanced-context-timeline-action', 'Timeline Action', 'Timeline opens the selected waypoint in the Timeline tab so you can inspect IDs, coordinates, aliases, attached Lorecards, and registry state.', 'context', 'context.workbench.timelineAction', { fallbackTarget: 'context.workbench.tab.timeline', prepare: 'openContextBrowser' }),
        advancedStep('advanced-context-manual-select', 'Manual Context Select', 'Manually select exact or ranged Context for loaded Lorepacks when detection is not authoritative.', 'context', 'context.workbench.editor', { fallbackTarget: 'context.workbench.contextPicker', prepare: 'openContextBrowser' }),
...
export const GUIDE_STEPS = Object.freeze({
    basic: freezeGuideSteps([
        ...
        guideStep('basic-context-anchors-windows', 'Anchors and Windows', 'Anchors are exact story points. Windows are ranges between story points. Browse Story Waypoints shows both so you can pick the right shape.', 'context', 'context.workbench.waypoints', {
        ...
        guideStep('basic-context-use-anchor', 'Use Anchor From Timeline', 'Use Anchor applies an exact Anchor from Select From Timeline. It is the precise-point version of Use Window.', 'context', 'context.workbench.useAnchor', {
        ...
        guideStep('basic-context-after-before', 'After, Before, Timeline', 'Use After on the lower bound and Before on the upper bound to build a custom Window. Use Timeline when you need to inspect the source row.', 'context', 'context.workbench.after', {
            ...
            prepare: 'openContextBrowser',
            expected: 'The Current Window shows the selected lower and upper bounds before you continue.',
