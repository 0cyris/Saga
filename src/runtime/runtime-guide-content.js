...
function buildAdvancedGuideSteps() {
    return [
        ...
        advancedStep('advanced-creator-create-deck', 'Create Deck', 'Launch Create Deck to begin a Generated Lorepack project. On mobile, the Creator workbench uses the same stages with a tighter current-task and review-queue layout.', 'loredecks', 'loredecks.creator.open', { fallbackTarget: 'loredecks.library.open', prepare: 'openLoredeckCreator' }),
...
export const GUIDE_SECTIONS = Object.freeze({
    ...
    advanced: freezeGuideSections([
        ...
        { id: 'creatorAuthoring', label: 'Creator And Generated Lorepack Authoring', tab: 'loredecks', description: 'Create and resume Generated Lorepack projects from scope brief through review and readiness, including the mobile Creator workbench.' },
