...
function buildAdvancedGuideSteps() {
    return [
        ...
        advancedStep('advanced-creator-entry-auto-draft', 'Auto-Draft All', 'Use Auto-Draft All when the project is ready to generate every remaining Lorecard after confirmation.', 'loredecks', 'loredecks.creator.entries', { fallbackTarget: 'loredecks.creator.workbench', prepare: 'openLoredeckCreator' }),
        ...
        advancedStep('advanced-health-attempt-fixing', 'Attempt Fixing', 'Run the primary Pack Health repair action for editable packs before choosing review or manual routes.', 'loredecks', 'loredecks.health.actions', { fallbackTarget: 'loredecks.health.issues', prepare: 'openDeckHealthCenter' }),
        advancedStep('advanced-health-manual-repair', 'Review And Manual Routes', 'Use review choices, Accept As-Is, or manual edits when Attempt Fixing cannot apply one clear fix.', 'loredecks', 'loredecks.health.actions', { fallbackTarget: 'loredecks.health.issues', prepare: 'openDeckHealthCenter' }),
