...
assert(basicGuideSource.includes("'loredecks.library.open'") && basicGuideSource.includes("'context.commandCenter'") && basicGuideSource.includes("'lore.pending'") && basicGuideSource.includes("'session.basicInjectionSummary'"), 'Basic guide must route through Loredeck, Context, Lorecards, and continue/update targets.');
...
assert(runtimePanelSource.includes('function createBasicStartReadinessCard'), 'Basic Session must render the Start Checklist card.');
...
assert(runtimePanelSource.includes('function createBasicInjectionSummaryCard'), 'Basic Session must show compact selected-lore prompt status.');
assert(runtimePanelSource.includes('function createBasicReviewInjectionSummary'), 'Basic Lorecards must show compact selected-lore prompt status.');
...
assert(panel.includes("'settings.providers'") && panel.includes("'settings.themePack'") && panel.includes("'settings.experienceMode'"), 'Basic Settings must use shared Providers and Theme Pack section names plus Experience Mode.');
